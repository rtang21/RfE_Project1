...
%%%%%%%% plot NPS %%%%%%%%%%
nps1 = NPS(phantom1(401:464,487:550,60:89),0.224609,0.224609);
nps2 = NPS(phantom2(401:464,487:550,70:99),0.224609,0.224609);
nps3 = NPS(phantom3(401:464,487:550,60:89),0.224609,0.224609);

figure; imshow(log(1+fftshift(abs(nps1))),[5 14]); title('NPS of phantom 1'); axis on
...
figure; imshow(log(1+fftshift(abs(nps2))),[5 14]); title('NPS of phantom 2'); axis on
set(gca, 'XTick', [1 16 33 48 64]); set(gca,'XTickLabel',{'-2.23','-1.18','0','1.18','2.23'});
xlabel('fx (/mm)')
set(gca, 'YTick', [1 16 33 48 64]); set(gca,'YTickLabel',{'-2.23','-1.18','0','1.18','2.23'});
ylabel('fy (/mm)')
...
figure; imshow(log(1+fftshift(abs(nps3))),[5 14]); title('NPS of phantom 3'); axis on
set(gca, 'XTick', [1 16 33 48 64]); set(gca,'XTickLabel',{'-2.23','-1.18','0','1.18','2.23'});
xlabel('fx (/mm)')
set(gca, 'YTick', [1 16 33 48 64]); set(gca,'YTickLabel',{'-2.23','-1.18','0','1.18','2.23'});
ylabel('fy (/mm)')
