...
%%%%%%%% plot NPS %%%%%%%%%%
nps1 = NPS(phantom1(:,:,70:105),0.224609,0.224609);
nps2 = NPS(phantom2(:,:,65:105),0.224609,0.224609);
nps3 = NPS(phantom3(:,:,70:100),0.224609,0.224609);
nps4 = NPS(phantom4(:,:,70:100),0.224609,0.224609);
nps5 = NPS(phantom5(:,:,70:100),0.224609,0.224609);
figure; imshow(log(1+fftshift(abs(nps1))),[9 29]); title('NPS of 1.3: phantom 1'); colorbar; colormap(hot)
figure; imshow(log(1+fftshift(abs(nps2))),[9 29]); title('NPS of 1.3: phantom 2'); colorbar; colormap(hot)
figure; imshow(log(1+fftshift(abs(nps3))),[9 29]); title('NPS of 1.3: phantom 3'); colorbar; colormap(hot)
figure; imshow(log(1+fftshift(abs(nps4))),[9 29]); title('NPS of 1.3: phantom 4'); colorbar; colormap(hot)
figure; imshow(log(1+fftshift(abs(nps5))),[9 29]); title('NPS of 1.3: phantom 5'); colorbar; colormap(hot)
