...
%%%%%%% plot NSP %%%%%%%%%%
nps1 = NPS(phantom1(:,:,70:99),0.224609,0.224609);
nps2 = NPS(phantom2(:,:,70:105),0.224609,0.224609);
figure; imshow(log(1+fftshift(abs(nps1))),[13 29]); title('NPS of 1.3X: phantom 1'); colorbar; colormap(hot)
figure; imshow(log(1+fftshift(abs(nps2))),[13 29]); title('NPS of 1.3X: phantom 2'); colorbar; colormap(hot)
